(function($) {
	...
	$('#Form-field-Document-status').change( function() { $.fn.setEmailButton($(this)); });
	$.fn.setEmailButton($('#Form-field-Document-status'));
    });
    ...
    $.fn.setEmailButton = function(elem) {
        if (elem.val() == 'published') {
	    $('#btn-email-sendings').prop('disabled', false);
	}
        else {
	    $('#btn-email-sendings').prop('disabled', true);
	}
    }
